...
characters[BORGHEN] = {
    ...
    battle_animations = {
        ...
        run_after_victory =     "data/new_assets/borghen_run_after_victory.lua", 
        attack =                "data/new_assets/borghen_attack.lua", 
        attack_forward_thrust = "data/entities/battle/characters/bronann/bronann_attack_forward_thrust.lua",
        dodge =                 "data/new_assets/borghen_dodge.lua",
        victory =               "data/new_assets/borghen_victory.lua", 
        hurt =                  "data/new_assets/borghen_hurt.lua", 
        poor =                  "data/new_assets/borghen_kneeling.lua",
        dying =                 "data/new_assets/borghen_kneeling.lua",
        dead =                  "data/new_assets/borghen_dead.lua",
        revive =                "data/new_assets/borghen_kneeling.lua",
