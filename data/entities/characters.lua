...
characters[SETZER] = {
    name = vt_system.Translate("Setzer"),
    portrait = "data/entities/portraits/bronann.png",
    full_portrait = "data/entities/portraits/bronann_full.png",
    battle_portraits = "data/entities/portraits/battle/bronann_damage.png",
    stamina_icon = "data/battles/stamina_icons/characters/bronann.png",
    map_sprite_name = "Setzer",
    special_skill_category_name = vt_system.Translate("Holy"),
    special_skill_category_icon = "data/gui/battle/holy.png",
    starting_skill_node_id = 27,

    image_file = "/home/fernando/Code/Battle/asset_dir/spritesheets_indexed/ogsetzer-p4.png",
...
characters[GOLBEZ] = {
    name = vt_system.Translate("Golbez"),
    portrait = "data/entities/portraits/bronann.png",
    full_portrait = "data/entities/portraits/bronann_full.png",
    battle_portraits = "data/entities/portraits/battle/bronann_damage.png",
    stamina_icon = "data/battles/stamina_icons/characters/bronann.png",
    map_sprite_name = "Aerith",
    special_skill_category_name = vt_system.Translate("Holy"),
    special_skill_category_icon = "data/gui/battle/holy.png",
    starting_skill_node_id = 27,

    image_file = "/home/fernando/Code/Battle/asset_dir/spritesheets_indexed/golbez-p3.png",
...
characters[AERITH] = {
    name = vt_system.Translate("Aerith"),
    portrait = "data/entities/portraits/bronann.png",
    full_portrait = "data/entities/portraits/bronann_full.png",
    battle_portraits = "data/entities/portraits/battle/bronann_damage.png",
    stamina_icon = "data/battles/stamina_icons/characters/bronann.png",
    ...
    image_file = "/home/fernando/Code/Battle/asset_dir/spritesheets_indexed/aerith-dress-p3.png",
